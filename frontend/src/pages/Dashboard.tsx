    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-6 space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 animate-fade-in">
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-0.5">Track your shared protein container in real time</p>
          </div>
          <button
      ...
      <footer className="border-t border-border/30 py-4 px-6 text-center">
        <p className="text-xs text-muted-foreground">
          Protein Tracker · Supabase backend · Auto-refreshes every 30s
        </p>
      </footer>
